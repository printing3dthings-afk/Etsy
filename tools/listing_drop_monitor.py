...
PRICE_FLOORS: list[tuple[str, float, str]] = [
    ("Ultimate Digital Life Planner",     13.99, "DP1026 — floor $13.99"),
    ("Student",                            8.99, "DP1027 — floor $8.99"),
    ("Budget",                             11.99, "DP1028 — floor $11.99"),
    ("Fitness",                            11.99, "DP1029 — floor $11.99"),
    ("SVG Bundle",                          8.99, "SVG bundles — floor $8.99"),
    ("SVG Cut File",                        8.99, "SVG cut files — floor $8.99"),
    ("Sublimation",                         6.99, "Sublimation — floor $6.99"),
    ("Commercial License",                 11.99, "Commercial licenses — floor $11.99"),
    ("Coloring Page",                        2.99, "Coloring pages — floor $2.99"),
    ("Kawaii Sticker",                       3.99, "Sticker packs — floor $3.99"),
    ("Wall Art Print",                      17.99, "Printify physical prints — floor $17.99"),
    ("Art Print",                           17.99, "Printify physical prints — floor $17.99"),
]
...
def check_price_floors(listings: list[dict], state: dict) -> list[str]:
    ...
    for listing in listings:
        ...
        for keyword, floor, label in PRICE_FLOORS:
