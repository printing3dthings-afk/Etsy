...
BUNDLES = {
    ...
    "floral_wreath": {
        ...
        "designs": [
            ...
            {"id": "03", "name": "Eucalyptus Crown",  "elements": "minimal elegant wreath of eucalyptus and olive branches only, no flowers, 'home' in simple thin script inside, very clean and modern botanical"},
            ...
            {"id": "13", "name": "Botanical Crown",   "elements": "floral crown arch (half-circle, open at the bottom) of roses, peonies, and trailing greenery — designed to sit on top of text or a monogram letter below"},
            ...
            {"id": "17", "name": "Monogram Frame",    "elements": "symmetrical botanical frame with roses and eucalyptus at top corners and trailing vines down the sides, large empty center oval for a monogram letter, elegant"},
            {"id": "18", "name": "Garden Gate",       "elements": "romantic arch of climbing roses over a garden gate, the gate is simple with a heart-shaped latch, trailing vines on each side pillar, no text"},
            ...
            {"id": "20", "name": "Forever Blooming",  "elements": "layered mandala-style floral design — a central rose surrounded by rings of petals, leaves, and small flowers getting larger outward, fully symmetrical, intricate"},
        ],
    },
    ...
    "mama_scripts": {
        ...
        "designs": [
            ...
            {"id": "04", "name": "World's Best Mom",  "elements": "circular badge design with 'World's Best Mom' text around the outer ring, star burst in center, small trophy icon, laurel leaves at bottom of badge"},
            ...
            {"id": "07", "name": "Mama Bear",         "elements": "cute mama bear silhouette with one small cub, pine trees and mountains in simple silhouette background, 'Mama Bear' bold arch lettering above"},
            ...
            {"id": "10", "name": "Favorite People",   "elements": "'My Favorite People Call Me Mom' in flowing script arranged in an oval shape, small heart in center, tiny flower and star accents around the oval edge"},
            ...
            {"id": "13", "name": "Chaos Coordinator", "elements": "'Chaos Coordinator' in bold energetic lettering, small lightning bolts and star bursts scattered around, 'title: Mom' on a ribbon banner below"},
            ...
            {"id": "19", "name": "Plant Mama",        "elements": "small collection of houseplant silhouettes — pothos, monstera leaf, cactus, succulent — 'Plant Mama' brush script in an arch above the plants"},
    ...
    "retro_groovy": {
        ...
        "designs": [
            ...
            {"id": "03", "name": "Far Out",           "elements": "retro oval badge with 'FAR OUT' bold psychedelic font inside, decorative mushroom and star accents, scalloped badge border, starburst background"},
            ...
            {"id": "07", "name": "Cosmic Dreamer",    "elements": "retro astronaut helmet with a daisy reflected in the visor, 'COSMIC DREAMER' psychedelic arch font above, saturn planet and stars surrounding"},
            ...
            {"id": "12", "name": "Magic Mushroom",    "elements": "large cute retro mushroom with polka dot cap, small stars and sparkles around it, 'MAGIC' script above on an arch, moon crescent behind the mushroom"},
            ...
            {"id": "14", "name": "Born Wild",         "elements": "retro eagle with wings spread wide, 'BORN WILD' bold arch lettering above, lightning bolts on each side, star burst in background, retro badge border"},
            ...
            {"id": "16", "name": "Rock and Roll",     "elements": "electric guitar silhouette, lightning bolt replacing the guitar neck, 'ROCK AND ROLL' bold retro font in arch, stars and music note accents"},
    ...
    "dark_floral": {
        ...
        "designs": [
            ...
            {"id": "06", "name": "Haunted Flora",     "elements": "twisted gothic vines forming a frame, dark flowers — black roses, night orchids — interspersed, two luna moths with detailed wings, no text — decorative"},
