...
COPYWRITER_TOOL_DEFINITIONS = [
    {
        "name": "load_client_profile",
        "description": "Load a client profile to understand their business, voice, audience, and goals before writing content.",
        "input_schema": {
            "type": "object",
            "properties": {
    ...
    {
        "name": "list_clients",
        "description": "List all saved client profiles to find available clients.",
        "input_schema": {"type": "object", "properties": {}, "required": []},
    },
    {
        ...
        "input_schema": {
            ...
            "properties": {
                ...
                "deliverable_type": {
                    "type": "string",
                    "description": "Type of content: social_posts, newsletter, ad_copy, content_calendar, blog_outline",
                },
                "month": {
                    "type": "string",
                    "description": "Month this content is for, e.g. 'June 2026'",
                },
    ...
    },
    {
        ...
        "description": "List all deliverables that have been saved for a client.",
        "input_schema": {
            "type": "object",
            "properties": {
                "client_id": {"type": "string", "description": "The client's slug ID"}
...
def execute_copywriter_tool(tool_name: str, tool_input: dict) -> str:
    ...
    return f"Unknown copywriter tool: {tool_name}"
