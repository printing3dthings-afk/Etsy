...
### 7. Hyperlinked Index Page (buyers see this first — it signals quality instantly)
...
### 10. Tab Color Customization (5 options — choose based on scheme)
...
### 11. Calendar Integration (mention in listing even if not enabled)
