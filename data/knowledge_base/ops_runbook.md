...
- **escalation — 5-minute health loop detected a problem: etsy: error: etsy api 0: no shop id con** — seen 21 times
- **monthly competitor research refresh** — seen 6 times
- **durable volume not writable** — seen 6 times
- **hub_db_state.json backup is stale** — seen 6 times
- **background build failed: build_planner:testcrash** — seen 6 times
- **background build hung: build_sticker_pack:testhung** — seen 6 times
