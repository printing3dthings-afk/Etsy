...
calls a real AI API) and image_gen.verify_original_art() (never calls a real
vision API) -- exercises generate_wall_art_master()'s own retry/fallback
logic directly. Isolates PRODUCT_FILES_DIR to a temp dir so this never
